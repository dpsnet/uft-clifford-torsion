...
\begin{equation}
    d_s(E) = 4 + \underbrace{\frac{6}{1+(E_{internal}/E)^2}}_{\text{upward: internal space opening}} - \underbrace{\frac{2}{1+(E_{torsion}/E)^2}}_{\text{downward: torsion confinement}}
\end{equation}
...
\textbf{Key insight}: ``Constraint'' is not an independent variable but a manifestation of torsion field energy. Both upward and downward flows are governed by the unified energy variable $E$.
...
\textbf{Upward flow} ($4 \to 10$): When $E > E_{internal}$, energy opens coupling to internal space, increasing accessible spectral dimension.

\textbf{Downward flow} ($4 \to 2$): When $E > E_{torsion}$, torsion field energy ``freezes'' degrees of freedom within reciprocal space, decreasing effective spectral dimension.
...
\textbf{Low energy} ($E \ll E_{torsion}, E_{internal}$): $d_s \approx 4$ (reciprocal space dominates)

\textbf{Intermediate energy} ($E_{torsion} < E < E_{internal}$): $d_s \approx 2$ (confinement dominates)

\textbf{High energy} ($E \gg E_{internal}$): $d_s \to 10$ (internal space opens)
