...
\textcolor{darkred}{\textbf{CTUFT}：0自由参数，包含引力}
\end{center}
\end{frame}
...
弦理论 & $10^{500}$+ & 有 & 否 & 未确认 \\
圈量子引力 & 1+ & 有 & 中 & 不完整 \\
\textbf{CTUFT} & \textbf{0} & \textbf{有} & \textbf{是} & \textbf{检验中} \\
\bottomrule
\end{tabular}
\end{center}
