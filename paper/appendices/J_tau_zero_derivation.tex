...
\begin{insight}[Curvature as Information Loss]
The curvature of the projected manifold is directly related to information loss:
\begin{equation}
    R^{(ind)} \propto \frac{I_{lost}}{I_{total}} \cdot \frac{1}{L^2}
\end{equation}
Higher curvature $\leftrightarrow$ More information lost in projection.
\end{insight}
