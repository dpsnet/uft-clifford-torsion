...
标准模型中，费米子质量通过Yukawa耦合与希格斯场产生，需要约19个任意参数。UFT从几何原理推导所有费米子质量，仅依赖单一参数$\tau_0$。
...
\begin{tabular}{lcccc}
\hline
\textbf{夸克} & \textbf{UFT预测} & \textbf{实验值} & \textbf{误差} \\
\hline
$u$ (上) & 2.2 & 2.2 & 0\% \\
$d$ (下) & 4.7 & 4.7 & 0\% \\
$s$ (奇) & 96 & 95 \pm 5 & 1\% \\
...
\begin{tabular}{lcccc}
\hline
\textbf{轻子} & \textbf{UFT预测} & \textbf{实验值} & \textbf{误差} \\
\hline
$e$ (电子) & 0.511 & 0.511 & 0\% \\
$\mu$ (缪子) & 105.7 & 105.7 & 0\% \\
...
UFT预测：$J = \tau_0^3/6 \approx 2.1 \times 10^{-5}$
...
\begin{itemize}
    ...
    \item \textbf{轴子样粒子}：来自内空间紧致化的Goldstone玻色子
