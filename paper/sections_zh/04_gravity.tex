...
\begin{enumerate}
    ...
    \item \textbf{$h_x$（矢量-x）}：$e_{xz} = e_{zx} = 1$ —— CTUFT预测
    \item \textbf{$h_y$（矢量-y）}：$e_{yz} = e_{zy} = 1$ —— CTUFT预测
    \item \textbf{$h_b$（呼吸）}：$e_{xx} = e_{yy} = 1$ —— CTUFT预测
    \item \textbf{$h_l$（纵向）}：$e_{zz} = 1$ —— CTUFT预测
\end{enumerate}
