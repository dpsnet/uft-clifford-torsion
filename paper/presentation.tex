...
\textcolor{darkred}{\textbf{UFT}: 0 free parameters, includes gravity}
\end{center}
\end{frame}
...
\begin{frame}{Comparison: UFT vs. Other Approaches}
\begin{center}
\begin{tabular}{lcccc}
\toprule
...
\textbf{UFT} & \textbf{0} & \textbf{Yes} & \textbf{Yes} & \textbf{Testing} \\
\bottomrule
\end{tabular}
\end{center}
