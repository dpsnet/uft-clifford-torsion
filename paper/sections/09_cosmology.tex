...
\caption{Cosmological evolution of spectral dimension (top) and temperature (bottom). Key epochs: Planck era ($d_s=10$), GUT phase transition ($d_s=7$), inflation end ($d_s=5$), and standard cosmology ($d_s=4$).}
