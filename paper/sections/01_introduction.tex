...
The single free parameter $\tau_0 = 10^{-6}$ is determined by experimental constraints from atomic clocks, Big Bang nucleosynthesis, and cosmological observations. This parameter controls the strength of torsion effects and yields quantitative predictions for all experimental tests.
