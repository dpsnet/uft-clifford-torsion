...
\caption{LISA sensitivity curve and predicted UFT signals. The six-polarization signal (red) shows a slight enhancement over standard GR (blue). For $\tau_0 = 10^{-6}$, the signal-to-noise ratio is SNR $\sim$ 7.}
