...
\caption{LISA sensitivity curve and predicted UFT signals. The six-polarization signal (red) shows a slight enhancement over standard GR (blue). For $\tau_0 = 0.005$, the signal-to-noise ratio is SNR $\sim$ 1000.}
...
\begin{equation}
    \frac{h_{UFT}}{h_{astrophysical}} \sim 10^{-4} \quad \text{(detectable with future PTA)}
\end{equation}
